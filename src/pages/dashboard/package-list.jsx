      ...
      <div className="pt-32 px-20 pb-16">
        <div className="bg-white p-6 pb-16">
          ...
          <div className="mt-8 flex justify-center items-center gap-10 mx-12">
            <div className="w-1/3 bg-gray-100 flex flex-col justify-center items-center pb-16">
              <Image
            ...
            {/*  */}
            <div className="w-1/3 bg-gray-100 flex flex-col justify-center items-center pb-12">
              <Image
                src="/dry-clean.png"
                alt="Karyawan"
                width={500}
